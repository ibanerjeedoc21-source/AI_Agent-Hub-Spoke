---
description: Runs the subag2print skill — creates a file, prints in PowerShell, and opens CMD window to display content.
mode: subagent
...
permission:
  ...
  write: allow
---
Before executing, read .claude/skills/subag2print/SKILL.md for usage
